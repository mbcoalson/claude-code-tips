...
🔒 **Security:** This repository has been reviewed for security vulnerabilities including prompt injection. [Read the security summary](SECURITY-SUMMARY.md) or [full security analysis](SECURITY.md).
